...
const _cache = __ins.renderCache;
	...
	const onSetTheme = (val : "light" | "dark") => {
		...
		if (state.uniPlatform === 'app') {
			uni.setAppTheme({
				...
				success: function () {
					console.log(`设置appTheme为 ${val} 成功`, " at pages/mine/index.uvue:62")
				},
				fail: function (e : IAppThemeFail) {
					console.log(`设置appTheme为 ${val} 失败,原因:`, e.errMsg, " at pages/mine/index.uvue:65")
				}
			})
		}
	}
	...
	const onShow = () => {
		console.log(688767868, " at pages/mine/index.uvue:72")
	}
