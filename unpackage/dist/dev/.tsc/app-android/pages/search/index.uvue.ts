import MyIcon from '@/componnets/MyIcon/index.uvue';
	...
	type SearchRecordItem = { __$originalPosition?: UTSSourceMapPosition<"SearchRecordItem", "pages/search/index.uvue", 53, 7>;
		id : string,
		text : string,
	}
	...
	const initData = () => {
		...
		uni.getStorage({
			...
			success: (res : GetStorageSuccess) => {
				const data = UTSAndroid.consoleDebugError(JSON.parse<Array<SearchRecordItem>>(JSON.stringify(res.data)), " at pages/search/index.uvue:142")
      ...
      unref(searchType) === 'record'
        ? _cE("view", _uM({
            ...
            _cE("view", _uM({
              ...
              _cV(unref(MyIcon), _uM({ name: "delete" }))
            ])
          ])
        : _cC("v-if", true),
            ...
            _cE(Fragment, null, RenderHelpers.renderList(unref(searchRecord), (item, __key, __index, _cached): any => {
              return _cE("view", _uM({
                ...
                _cE("view", _uM({
                  ...
                  _cV(unref(MyIcon), _uM({ name: "close" }))
                ], 8 /* PROPS */, ["onClick"])
              ], 8 /* PROPS */, ["onClick"])
