...
function defineAppConfig(){
  ...
  __uniConfig.globalStyle = _uM([["backgroundColorContent","@globalStyleBackgroundColor"],["navigationBarTextStyle","@globalStyleNavigationBarTextStyle"],["navigationStyle","custom"]])
