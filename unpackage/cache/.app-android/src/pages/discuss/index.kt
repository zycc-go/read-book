...
open class GenPagesDiscussIndex : BasePage {
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("page" to _pS(_uM("backgroundColor" to "var(--rice-navbar-background)", "height" to "100%", "width" to "100%")), "tabs" to _pS(_uM("height" to 44, "display" to "flex", "flexDirection" to "row", "alignItems" to "center", "paddingTop" to 0, "paddingRight" to 4, "paddingBottom" to 0, "paddingLeft" to 4)), "tab" to _uM(".tabs " to _uM("paddingTop" to 0, "paddingRight" to 12, "paddingBottom" to 0, "paddingLeft" to 12, "position" to "relative", "display" to "flex", "flexDirection" to "row", "alignItems" to "center", "height" to "100%")), "tab-indicator" to _uM(".tabs " to _uM("width" to 20, "height" to 3, "position" to "absolute", "bottom" to 4, "left" to "50%", "transform" to "translateX(-50%)", "zIndex" to 1, "borderTopLeftRadius" to 100, "borderTopRightRadius" to 100, "borderBottomRightRadius" to 100, "borderBottomLeftRadius" to 100, "backgroundColor" to "var(--rice-primary-color)")), "item-text" to _uM(".tabs " to _uM("color" to "var(--text-color-1)"), ".card .item .item-top " to _uM("marginLeft" to 5)), "card" to _pS(_uM("paddingTop" to 0, "paddingRight" to 16, "paddingBottom" to 12, "paddingLeft" to 16)), "item-index" to _uM(".card " to _uM("marginTop" to 8)), "item" to _uM(".card " to _uM("paddingTop" to 12, "paddingRight" to 16, "paddingBottom" to 12, "paddingLeft" to 16, "backgroundColor" to "var(--background-color-3)", "borderTopLeftRadius" to 6, "borderTopRightRadius" to 6, "borderBottomRightRadius" to 6, "borderBottomLeftRadius" to 6)), "item-top" to _uM(".card .item " to _uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center")), "item-tit" to _uM(".card .item .item-top .item-text " to _uM("color" to "var(--text-color-1)")), "item-content" to _uM(".card .item " to _uM("paddingTop" to 12, "paddingRight" to 0, "paddingBottom" to 12, "paddingLeft" to 0, "color" to "var(--text-color-2)")), "item-bottom" to _uM(".card .item " to _uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "justifyContent" to "space-around")), "item-hand" to _uM(".card .item " to _uM("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "justifyContent" to "center", "flexGrow" to 1, "flexShrink" to 1, "flexBasis" to "0%")), "item-hand-num" to _uM(".card .item .item-hand " to _uM("color" to "var(--text-color-1)", "fontSize" to 12)), "fab-btn" to _pS(_uM("position" to "absolute", "right" to 16, "bottom" to 16)))
            }
